...
def emit_type(type_info):
    ...
    declaration = type_info.to_c_string()
    ...
    # Hack to ignore <anonymous> types for now
    if declaration[0] != '<':
        # Emit type description as generated by the type comprehension system
        description_type = type_comprehension.type_comprehender.get_type_description(declaration)
